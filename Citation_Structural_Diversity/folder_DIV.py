...
def build_temp_graph(G, embedding_files_folder, paper_ids, output_file):
    ...
    # output_folder = 'F:/mingyue/specter/pythonProject1/seven_div/year_venue_div1'
    ...
    with open(output_file, mode, encoding='utf-8') as json_file:
        ...
        for node_id in G:
            ...
            for in_neighbor in in_neighbors:
                G_temp.add_edge(in_neighbor, node_id)  # 修改为入度边方向
...
output_folder = 'F:/mingyue/specter/pythonProject1/seven_div/year_venue_50_div1'
