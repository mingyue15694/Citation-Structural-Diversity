    ...
    with open(output_file, mode, encoding='utf-8') as json_file:
        ...
        for node_id in G:
            ...
            if Similarity2:
                ...
                similarity_threshold_text2 = [avg_similarity2]


            else:

                similarity_threshold_text2 = [0.0]

            all_similarity_thresholds = similarity_thresholds1
            similarity_threshold_texts = similarity_threshold_text2
            # print(all_similarity_thresholds)

            node_data_list1 = [[] for _ in range(50)]
            node_data_list2 = [[] for _ in range(50)]
            d1 = 1


            print(all_similarity_thresholds)
            print(similarity_threshold_texts)

            for similarity_threshold, similarity_threshold_text in product(all_similarity_thresholds,
                                                                           similarity_threshold_texts):
...
output_folder = 'F:/mingyue/specter/pythonProject1/seven_div/year_venue_50_div4'
os.makedirs(output_folder, exist_ok=True)  # 确保输出目录存在

data_text_folder = 'F:/mingyue/specter/pythonProject1/year_venue_50_2'
