    ...
    with open(output_file, 'w', encoding='utf-8') as json_file:
        for node_id in G:
            ...
            if Similarity1:
                ...
                avg_between_quartiles1 = np.mean(
                    [sim for sim in Similarity1 if quartiles1[0] < sim < quartiles1[2]])

                # 将这些统计值作为相似度阈值
                similarity_thresholds1 = [avg_between_quartiles1]
...
output_folder = 'F:/mingyue/specter/pythonProject1/pubmed_div4'
