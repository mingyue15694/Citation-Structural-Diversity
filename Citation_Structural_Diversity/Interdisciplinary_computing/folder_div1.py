...
def build_temp_graph(G, embedding_file_path, output_file):
    ...
    with open(output_file, 'w', encoding='utf-8') as json_file:
        ...
        for node_id in G:
            ...
            node_data = {
                "paper_id": node_id,
                f"node_diversity1": node_diversity1,
...
# 从文件读取嵌入向量
embedding_folder = 'F:/mingyue/specter/pythonProject1/pubmed_embedding'
...
output_folder = 'F:/mingyue/specter/pythonProject1/pubmed_div'
output_folder = os.path.dirname(output_folder)  # 获取文件的目录路径
...
for filename in os.listdir(data_text_folder):
    if filename.endswith(".json"):
        ...
        embedding_file_path = os.path.join(r'F:\mingyue\specter\pythonProject1\pubmed_embedding',
